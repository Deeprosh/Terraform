# Terraform Providers  
*we create providers in main.tf file and this provider is a plugin and acts as a medium for terraform to understand where it needs to create a resource or infrastructure.*  
